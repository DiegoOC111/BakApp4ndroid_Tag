...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "BaKapp.Movil.Tag.b4xformatter");
            if (htSubs == null) {
...
public String  _addformatdata(BaKapp.Movil.Tag.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public BaKapp.Movil.Tag.b4xformatter._b4xformatdata  _copyformatdata(BaKapp.Movil.Tag.b4xformatter._b4xformatdata _data) throws Exception{
...
public BaKapp.Movil.Tag.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
BaKapp.Movil.Tag.b4xformatter._b4xformatdata _d = null;
...
public BaKapp.Movil.Tag.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (BaKapp.Movil.Tag.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 80;BA.debugLine="End Sub";
return null;
}
public BaKapp.Movil.Tag.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
BaKapp.Movil.Tag.b4xformatter._b4xformatdata _d = null;
...
_d = (BaKapp.Movil.Tag.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public BaKapp.Movil.Tag.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
