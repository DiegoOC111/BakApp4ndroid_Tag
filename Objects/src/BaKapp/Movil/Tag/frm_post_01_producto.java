...
anywheresoftware.b4a.keywords.Common.LogImpl("721954594","Stock disponible: "+BA.NumberToString(_stock_disponible)+", Stock fisico: "+BA.NumberToString(_stock_fisico),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("721954647",_js._errormessage /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("722216762","Traer Stock x bodega",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("722413349","Traer Ubicación x bodega",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("722347806","Traer Stock x bodega",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("722282279","Traer Stock x bodega",0);
