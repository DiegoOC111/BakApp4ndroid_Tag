...
anywheresoftware.b4a.keywords.Common.LogImpl("422020130","Stock disponible: "+BA.NumberToString(_stock_disponible)+", Stock fisico: "+BA.NumberToString(_stock_fisico),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("422020183",_js._errormessage /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("422282298","Traer Stock x bodega",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("422478885","Traer Ubicación x bodega",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("422413342","Traer Stock x bodega",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("422347815","Traer Stock x bodega",0);
