...
anywheresoftware.b4a.keywords.Common.LogImpl("221430306","Stock disponible: "+BA.NumberToString(_stock_disponible)+", Stock fisico: "+BA.NumberToString(_stock_fisico),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("221430359",_js._errormessage /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("221692474","Traer Stock x bodega",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("221889061","Traer Ubicación x bodega",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("221823518","Traer Stock x bodega",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("221757991","Traer Stock x bodega",0);
