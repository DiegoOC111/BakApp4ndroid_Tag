...
anywheresoftware.b4a.keywords.Common.LogImpl("417760270","CreateTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("418874373","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("418874383","DeleteRecord: "+_sb.ToString(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("417825794","DropTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("418481159","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("418546695","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("418415624","ExecuteJSON: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("418415644","Invalid type: "+BA.ObjectToString(_dbtypes.Get(_i)),0);
 break; }
}
;
 }
...
anywheresoftware.b4a.keywords.Common.LogImpl("418022408","ExecuteMap: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("418022410","No records found.",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("417956870","ExecuteMemoryTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("417891332","Mismo mapa encontrado dos veces en la lista. Cada elemento de la lista debe incluir un objeto de mapa diferente.",0);
...
if (_i1==0) { 
anywheresoftware.b4a.keywords.Common.LogImpl("417891356","InsertMaps (first query out of "+BA.NumberToString(_listofmaps.getSize())+"): "+_sb.ToString(),0);};
...
anywheresoftware.b4a.keywords.Common.LogImpl("417891361",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("418808834","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("418808838","Fields empty",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("418808859","UpdateRecord: "+_sb.ToString(),0);
