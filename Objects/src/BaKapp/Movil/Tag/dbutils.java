...
anywheresoftware.b4a.keywords.Common.LogImpl("716973838","CreateTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("718087941","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("718087951","DeleteRecord: "+_sb.ToString(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717039362","DropTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717694727","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717760263","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717629192","ExecuteJSON: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717629212","Invalid type: "+BA.ObjectToString(_dbtypes.Get(_i)),0);
 break; }
}
;
 }
...
anywheresoftware.b4a.keywords.Common.LogImpl("717235976","ExecuteMap: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717235978","No records found.",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717170438","ExecuteMemoryTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717104900","Mismo mapa encontrado dos veces en la lista. Cada elemento de la lista debe incluir un objeto de mapa diferente.",0);
...
if (_i1==0) { 
anywheresoftware.b4a.keywords.Common.LogImpl("717104924","InsertMaps (first query out of "+BA.NumberToString(_listofmaps.getSize())+"): "+_sb.ToString(),0);};
...
anywheresoftware.b4a.keywords.Common.LogImpl("717104929",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("718022402","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("718022406","Fields empty",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("718022427","UpdateRecord: "+_sb.ToString(),0);
