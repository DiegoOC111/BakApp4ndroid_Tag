...
anywheresoftware.b4a.keywords.Common.LogImpl("716580622","CreateTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717694725","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717694735","DeleteRecord: "+_sb.ToString(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("716646146","DropTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717301511","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717367047","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717235976","ExecuteJSON: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717235996","Invalid type: "+BA.ObjectToString(_dbtypes.Get(_i)),0);
 break; }
}
;
 }
...
anywheresoftware.b4a.keywords.Common.LogImpl("716842760","ExecuteMap: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("716842762","No records found.",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("716777222","ExecuteMemoryTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("716711684","Mismo mapa encontrado dos veces en la lista. Cada elemento de la lista debe incluir un objeto de mapa diferente.",0);
...
if (_i1==0) { 
anywheresoftware.b4a.keywords.Common.LogImpl("716711708","InsertMaps (first query out of "+BA.NumberToString(_listofmaps.getSize())+"): "+_sb.ToString(),0);};
...
anywheresoftware.b4a.keywords.Common.LogImpl("716711713",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("717629186","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717629190","Fields empty",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("717629211","UpdateRecord: "+_sb.ToString(),0);
