...
anywheresoftware.b4a.keywords.Common.LogImpl("616711694","CreateTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("617825797","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("617825807","DeleteRecord: "+_sb.ToString(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("616777218","DropTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("617432583","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("617498119","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("617367048","ExecuteJSON: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("617367068","Invalid type: "+BA.ObjectToString(_dbtypes.Get(_i)),0);
 break; }
}
;
 }
...
anywheresoftware.b4a.keywords.Common.LogImpl("616973832","ExecuteMap: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("616973834","No records found.",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("616908294","ExecuteMemoryTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("616842756","Mismo mapa encontrado dos veces en la lista. Cada elemento de la lista debe incluir un objeto de mapa diferente.",0);
...
if (_i1==0) { 
anywheresoftware.b4a.keywords.Common.LogImpl("616842780","InsertMaps (first query out of "+BA.NumberToString(_listofmaps.getSize())+"): "+_sb.ToString(),0);};
...
anywheresoftware.b4a.keywords.Common.LogImpl("616842785",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("617760258","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("617760262","Fields empty",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("617760283","UpdateRecord: "+_sb.ToString(),0);
