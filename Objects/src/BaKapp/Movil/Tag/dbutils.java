...
anywheresoftware.b4a.keywords.Common.LogImpl("19502734","CreateTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("110616837","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("110616847","DeleteRecord: "+_sb.ToString(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("19568258","DropTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("110223623","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("110289159","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("110158088","ExecuteJSON: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("110158108","Invalid type: "+BA.ObjectToString(_dbtypes.Get(_i)),0);
 break; }
}
;
 }
...
anywheresoftware.b4a.keywords.Common.LogImpl("19764872","ExecuteMap: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("19764874","No records found.",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("19699334","ExecuteMemoryTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("19633796","Mismo mapa encontrado dos veces en la lista. Cada elemento de la lista debe incluir un objeto de mapa diferente.",0);
...
if (_i1==0) { 
anywheresoftware.b4a.keywords.Common.LogImpl("19633820","InsertMaps (first query out of "+BA.NumberToString(_listofmaps.getSize())+"): "+_sb.ToString(),0);};
...
anywheresoftware.b4a.keywords.Common.LogImpl("19633825",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("110551298","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("110551302","Fields empty",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("110551323","UpdateRecord: "+_sb.ToString(),0);
