...
anywheresoftware.b4a.keywords.Common.LogImpl("711141134","CreateTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("712255237","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("712255247","DeleteRecord: "+_sb.ToString(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("711206658","DropTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("711862023","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("711927559","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("711796488","ExecuteJSON: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("711796508","Invalid type: "+BA.ObjectToString(_dbtypes.Get(_i)),0);
 break; }
}
;
 }
...
anywheresoftware.b4a.keywords.Common.LogImpl("711403272","ExecuteMap: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("711403274","No records found.",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("711337734","ExecuteMemoryTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("711272196","Mismo mapa encontrado dos veces en la lista. Cada elemento de la lista debe incluir un objeto de mapa diferente.",0);
...
if (_i1==0) { 
anywheresoftware.b4a.keywords.Common.LogImpl("711272220","InsertMaps (first query out of "+BA.NumberToString(_listofmaps.getSize())+"): "+_sb.ToString(),0);};
...
anywheresoftware.b4a.keywords.Common.LogImpl("711272225",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("712189698","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("712189702","Fields empty",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("712189723","UpdateRecord: "+_sb.ToString(),0);
