...
anywheresoftware.b4a.keywords.Common.LogImpl("514352398","CreateTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("515466501","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("515466511","DeleteRecord: "+_sb.ToString(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("514417922","DropTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("515073287","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("515138823","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("515007752","ExecuteJSON: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("515007772","Invalid type: "+BA.ObjectToString(_dbtypes.Get(_i)),0);
 break; }
}
;
 }
...
anywheresoftware.b4a.keywords.Common.LogImpl("514614536","ExecuteMap: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("514614538","No records found.",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("514548998","ExecuteMemoryTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("514483460","Mismo mapa encontrado dos veces en la lista. Cada elemento de la lista debe incluir un objeto de mapa diferente.",0);
...
if (_i1==0) { 
anywheresoftware.b4a.keywords.Common.LogImpl("514483484","InsertMaps (first query out of "+BA.NumberToString(_listofmaps.getSize())+"): "+_sb.ToString(),0);};
...
anywheresoftware.b4a.keywords.Common.LogImpl("514483489",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("515400962","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("515400966","Fields empty",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("515400987","UpdateRecord: "+_sb.ToString(),0);
