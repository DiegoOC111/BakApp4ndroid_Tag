...
anywheresoftware.b4a.keywords.Common.LogImpl("414024733",_codigo,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("414024787",_js._errormessage /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("413893653",_codigo,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("413893682",_js._errormessage /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("413762605",_vjson,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("413762640",_codigo+" - "+_descripcion,0);
 if (true) break;
