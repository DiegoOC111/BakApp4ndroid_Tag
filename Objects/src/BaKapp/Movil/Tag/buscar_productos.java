...
anywheresoftware.b4a.keywords.Common.LogImpl("712255261",_codigo,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("712255315",_js._errormessage /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("712124181",_codigo,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("712124210",_js._errormessage /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("711993133",_vjson,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("711993168",_codigo+" - "+_descripcion,0);
 if (true) break;
