...
anywheresoftware.b4a.keywords.Common.LogImpl("72097181",_codigo,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("72097235",_js._errormessage /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("71966101",_codigo,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("71966130",_js._errormessage /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("71835053",_vjson,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("71835088",_codigo+" - "+_descripcion,0);
 if (true) break;
