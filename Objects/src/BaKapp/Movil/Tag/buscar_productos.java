...
anywheresoftware.b4a.keywords.Common.LogImpl("76422557",_codigo,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("76422611",_js._errormessage /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("76291477",_codigo,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("76291506",_js._errormessage /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("76160429",_vjson,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("76160464",_codigo+" - "+_descripcion,0);
 if (true) break;
