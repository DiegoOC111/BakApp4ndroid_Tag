...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "BaKapp.Movil.Tag.b4xdatetemplate");
            if (htSubs == null) {
...
public ResumableSub_Show(BaKapp.Movil.Tag.b4xdatetemplate parent,BaKapp.Movil.Tag.b4xdialog _dialog) {
this.parent = parent;
