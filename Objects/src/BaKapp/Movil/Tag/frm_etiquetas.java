...
//C
this.state = 1;
 //BA.debugLineNum = 62;BA.debugLine="Activity.LoadLayout(\"Etiqueta_men\")";
parent.mostCurrent._activity.LoadLayout("Etiqueta_men",mostCurrent.activityBA);
 //BA.debugLineNum = 65;BA.debugLine="Changes = False";
parent._changes = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 66;BA.debugLine="Dim Js As HttpJob = Sb_BuscarListaPrecios(Me)";
_js = _sb_buscarlistaprecios(frm_etiquetas.getObject());
 //BA.debugLineNum = 67;BA.debugLine="Wait For (Js) JobDone(Js As HttpJob)";
...
;
 //BA.debugLineNum = 69;BA.debugLine="If Js.Success Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 70;BA.debugLine="Dim vJson As String = Js.GetString";
_vjson = _js._getstring /*String*/ ();
 //BA.debugLineNum = 72;BA.debugLine="If  vJson = $\"{\"Table\":[]}\"$ Then";
if (true) break;
...
_bmp1 = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 75;BA.debugLine="bmp1 = LoadBitmap(File.DirAssets, \"emoticon-sad";
_bmp1 = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"emoticon-sad.png");
 //BA.debugLineNum = 76;BA.debugLine="Msgbox2Async(\"Error al buscar la lista de preci";
anywheresoftware.b4a.keywords.Common.Msgbox2Async(BA.ObjectToCharSequence("Error al buscar la lista de precios."),BA.ObjectToCharSequence("Error"),"OK","","",_bmp1,processBA,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 77;BA.debugLine="Wait For Msgbox_Result (Result5 As Int)";
...
;
 //BA.debugLineNum = 79;BA.debugLine="If Result5 = DialogResponse.POSITIVE Then";
if (true) break;
...
this.state = 14;
;
 //BA.debugLineNum = 86;BA.debugLine="DataPrice = ParseOtherPriceJSON(vJson)";
...
//C
this.state = 14;
 //BA.debugLineNum = 89;BA.debugLine="bmp1 = LoadBitmap(File.DirAssets, \"emoticon-sad.";
_bmp1 = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"emoticon-sad.png");
 //BA.debugLineNum = 90;BA.debugLine="Msgbox2Async(\"Error al comunicarse con la base d";
anywheresoftware.b4a.keywords.Common.Msgbox2Async(BA.ObjectToCharSequence("Error al comunicarse con la base de datos."),BA.ObjectToCharSequence("Error"),"OK","","",_bmp1,processBA,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 91;BA.debugLine="Wait For Msgbox_Result (Result5 As Int)";
anywheresoftware.b4a.keywords.Common.WaitFor("msgbox_result", processBA, this, null);
this.state = 21;
return;
case 21:
...
this.state = 15;
;
 //BA.debugLineNum = 99;BA.debugLine="stringListPrice.Initialize";
parent.mostCurrent._stringlistprice.Initialize();
 //BA.debugLineNum = 100;BA.debugLine="For Each p As OtherPriceData In DataPrice";
if (true) break;
...
//C
this.state = 23;
 //BA.debugLineNum = 101;BA.debugLine="stringListPrice.Add(p.KOLT &\" | \"& p.NOKOLT)";
...
this.state = -1;
;
 //BA.debugLineNum = 103;BA.debugLine="SelectedPrice = 0";
parent._selectedprice = (int) (0);
 //BA.debugLineNum = 104;BA.debugLine="Dim aux As OtherPriceData = DataPrice.Get(Selecte";
_aux = (BaKapp.Movil.Tag.frm_impresion._otherpricedata)(parent.mostCurrent._dataprice.Get(parent._selectedprice));
 //BA.debugLineNum = 105;BA.debugLine="stringPrecio = aux.KOLT";
parent._stringprecio = _aux.KOLT /*String*/ ;
 //BA.debugLineNum = 106;BA.debugLine="LeerDatos";
_leerdatos();
 //BA.debugLineNum = 107;BA.debugLine="CargarLista";
_cargarlista();
...
public static String  _btn_cerrar_click() throws Exception{
 //BA.debugLineNum = 441;BA.debugLine="Private Sub Btn_Cerrar_Click";
 //BA.debugLineNum = 442;BA.debugLine="General.Visible= True";
mostCurrent._general.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 443;BA.debugLine="Panel_Conf.Visible = False";
...
public static String  _btn_conf_click() throws Exception{
 //BA.debugLineNum = 434;BA.debugLine="Private Sub Btn_Conf_Click";
 //BA.debugLineNum = 435;BA.debugLine="General.Visible= False";
mostCurrent._general.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 436;BA.debugLine="Btn_Guardar.Color = ColorDisabled";
mostCurrent._btn_guardar.setColor(_colordisabled);
 //BA.debugLineNum = 437;BA.debugLine="IsEnabled = False";
_isenabled = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 438;BA.debugLine="Panel_Conf.Visible = True";
...
//C
this.state = 1;
 //BA.debugLineNum = 456;BA.debugLine="Private InputTemplate As B4XInputTemplate";
_inputtemplate = new BaKapp.Movil.Tag.b4xinputtemplate();
 //BA.debugLineNum = 457;BA.debugLine="Private Base As B4XView";
_base = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 458;BA.debugLine="Private dialog As B4XDialog";
_dialog = new BaKapp.Movil.Tag.b4xdialog();
 //BA.debugLineNum = 462;BA.debugLine="InputTemplate.Initialize";
_inputtemplate._initialize /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 464;BA.debugLine="Base = Activity";
_base = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(parent.mostCurrent._activity.getObject()));
 //BA.debugLineNum = 465;BA.debugLine="dialog.Initialize (Base)";
_dialog._initialize /*String*/ (mostCurrent.activityBA,_base);
 //BA.debugLineNum = 468;BA.debugLine="InputTemplate.lblTitle.Text = \"Ingrese la ip\"";
_inputtemplate._lbltitle /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setText(BA.ObjectToCharSequence("Ingrese la ip"));
 //BA.debugLineNum = 469;BA.debugLine="InputTemplate.Text = \"\"";
_inputtemplate._text /*String*/  = "";
 //BA.debugLineNum = 472;BA.debugLine="Wait For (dialog.ShowTemplate(InputTemplate, \"OK\"";
...
;
 //BA.debugLineNum = 473;BA.debugLine="If (Res = DialogResponse.CANCEL) Then";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 476;BA.debugLine="Changes = True";
parent._changes = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 477;BA.debugLine="Lbl_IP.Text = InputTemplate.Text";
...
//C
this.state = 1;
 //BA.debugLineNum = 482;BA.debugLine="Private InputTemplate As B4XInputTemplate";
_inputtemplate = new BaKapp.Movil.Tag.b4xinputtemplate();
 //BA.debugLineNum = 483;BA.debugLine="Private Base As B4XView";
_base = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 484;BA.debugLine="Private dialog As B4XDialog";
_dialog = new BaKapp.Movil.Tag.b4xdialog();
 //BA.debugLineNum = 488;BA.debugLine="InputTemplate.Initialize";
_inputtemplate._initialize /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 490;BA.debugLine="Base = Activity";
_base = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(parent.mostCurrent._activity.getObject()));
 //BA.debugLineNum = 491;BA.debugLine="dialog.Initialize (Base)";
_dialog._initialize /*String*/ (mostCurrent.activityBA,_base);
 //BA.debugLineNum = 495;BA.debugLine="InputTemplate.lblTitle.Text = \"Ingrese el nombre\"";
_inputtemplate._lbltitle /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setText(BA.ObjectToCharSequence("Ingrese el nombre"));
 //BA.debugLineNum = 496;BA.debugLine="InputTemplate.Text = \"\"";
_inputtemplate._text /*String*/  = "";
 //BA.debugLineNum = 498;BA.debugLine="Wait For (dialog.ShowTemplate(InputTemplate, \"OK\"";
anywheresoftware.b4a.keywords.Common.WaitFor("complete", processBA, this, _dialog._showtemplate /*anywheresoftware.b4a.keywords.Common.ResumableSubWrapper*/ ((Object)(_inputtemplate),(Object)("OK"),(Object)(""),(Object)("CANCEL")));
this.state = 5;
return;
case 5:
...
_res = (Integer) result[0];
;
 //BA.debugLineNum = 499;BA.debugLine="If (Res = DialogResponse.CANCEL) Then";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 502;BA.debugLine="Changes = True";
parent._changes = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 503;BA.debugLine="Lbl_Nombre.Text = InputTemplate.Text";
...
public static String  _btn_etq1_click() throws Exception{
 //BA.debugLineNum = 446;BA.debugLine="Private Sub Btn_Etq1_Click";
 //BA.debugLineNum = 447;BA.debugLine="StartActivity(Frm_impresion)";
...
public static String  _btn_etq2_click() throws Exception{
 //BA.debugLineNum = 451;BA.debugLine="Private Sub Btn_Etq2_Click";
 //BA.debugLineNum = 452;BA.debugLine="StartActivity(Frm_impresion)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._frm_impresion.getObject()));
...
//C
this.state = 1;
 //BA.debugLineNum = 536;BA.debugLine="If Changes Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 537;BA.debugLine="Dim bmp1 As Bitmap";
_bmp1 = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 538;BA.debugLine="bmp1 = LoadBitmap(File.DirAssets, \"security-dang";
_bmp1 = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"security-danger.png");
 //BA.debugLineNum = 539;BA.debugLine="Msgbox2Async(\"Se realizaron cambios en la config";
anywheresoftware.b4a.keywords.Common.Msgbox2Async(BA.ObjectToCharSequence("Se realizaron cambios en la configuración, debe probar conexión antes de guradar"),BA.ObjectToCharSequence("Configuración Impresora "),"Continuar","","",_bmp1,processBA,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 540;BA.debugLine="Wait For Msgbox_Result (Result As Int)";
anywheresoftware.b4a.keywords.Common.WaitFor("msgbox_result", processBA, this, null);
this.state = 30;
return;
case 30:
...
if (true) return ;
 if (true) break;
;
 //BA.debugLineNum = 543;BA.debugLine="If IsEnabled Then";
...
_bmp1 = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 545;BA.debugLine="bmp1 = LoadBitmap(File.DirAssets, \"save.png\")";
_bmp1 = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"save.png");
 //BA.debugLineNum = 546;BA.debugLine="Msgbox2Async(\"¿Desea guardar la configuración ac";
...
_result = (Integer) result[0];
;
 //BA.debugLineNum = 548;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
if (true) break;
...
//C
this.state = 10;
 //BA.debugLineNum = 549;BA.debugLine="If Lbl_puerto.Text <> \"---\" Then";
if (true) break;
...
//C
this.state = 13;
 //BA.debugLineNum = 551;BA.debugLine="If Lbl_IP.Text <> \"---\" Then";
if (true) break;
...
//C
this.state = 16;
 //BA.debugLineNum = 552;BA.debugLine="If Lbl_Nombre.Text <> \"---\" Then";
if (true) break;
...
//C
this.state = 1;
 //BA.debugLineNum = 518;BA.debugLine="If Ping(Lbl_IP.Text) Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 519;BA.debugLine="Dim bmp1 As Bitmap";
_bmp1 = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 520;BA.debugLine="bmp1 = LoadBitmap(File.DirAssets, \"printer.png\")";
_bmp1 = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"printer.png");
 //BA.debugLineNum = 521;BA.debugLine="Msgbox2Async(\"Conexión exitosa\" , \"Notificación\"";
anywheresoftware.b4a.keywords.Common.Msgbox2Async(BA.ObjectToCharSequence("Conexión exitosa"),BA.ObjectToCharSequence("Notificación"),"Aceptar","Cancelar","",_bmp1,processBA,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 522;BA.debugLine="Wait For Msgbox_Result (Result As Int)";
anywheresoftware.b4a.keywords.Common.WaitFor("msgbox_result", processBA, this, null);
this.state = 5;
return;
case 5:
...
_result = (Integer) result[0];
;
 //BA.debugLineNum = 524;BA.debugLine="IsEnabled = True";
parent._isenabled = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 525;BA.debugLine="Changes = False";
parent._changes = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 526;BA.debugLine="Btn_Guardar.Color = ColorEnabled";
...
this.state = -1;
;
 //BA.debugLineNum = 529;BA.debugLine="Dim bmp1 As Bitmap";
_bmp1 = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 530;BA.debugLine="bmp1 = LoadBitmap(File.DirAssets, \"security-dange";
_bmp1 = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"security-danger.png");
 //BA.debugLineNum = 531;BA.debugLine="Msgbox2Async(\"Conexión Fallida\" , \"Notificación\",";
anywheresoftware.b4a.keywords.Common.Msgbox2Async(BA.ObjectToCharSequence("Conexión Fallida"),BA.ObjectToCharSequence("Notificación"),"Aceptar","","",_bmp1,processBA,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 532;BA.debugLine="Wait For Msgbox_Result (Result As Int)";
anywheresoftware.b4a.keywords.Common.WaitFor("msgbox_result", processBA, this, null);
this.state = 6;
return;
case 6:
...
//C
this.state = 1;
 //BA.debugLineNum = 194;BA.debugLine="ProgressDialogShow2(\"Cargando etiquetas\",False)";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow2(mostCurrent.activityBA,BA.ObjectToCharSequence("Cargando etiquetas"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 195;BA.debugLine="clv.Clear";
parent.mostCurrent._clv._clear();
 //BA.debugLineNum = 196;BA.debugLine="Dim ListaPersonas As List";
_listapersonas = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 197;BA.debugLine="ListaPersonas.Initialize";
_listapersonas.Initialize();
 //BA.debugLineNum = 203;BA.debugLine="Dim Js As HttpJob = Sb_TraerEtiquetas(Me)";
_js = _sb_traeretiquetas(frm_etiquetas.getObject());
 //BA.debugLineNum = 204;BA.debugLine="Wait For (Js) JobDone(Js As HttpJob)";
anywheresoftware.b4a.keywords.Common.WaitFor("jobdone", processBA, this, (Object)(_js));
this.state = 38;
return;
case 38:
...
_js = (BaKapp.Movil.Tag.httpjob) result[0];
;
 //BA.debugLineNum = 206;BA.debugLine="If Js.Success Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 207;BA.debugLine="Dim vJson As String = Js.GetString";
_vjson = _js._getstring /*String*/ ();
 //BA.debugLineNum = 209;BA.debugLine="If  vJson = $\"{\"Table\":[]}\"$ Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 210;BA.debugLine="Dim bmp1 As Bitmap";
_bmp1 = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
...
_result5 = (Integer) result[0];
;
 //BA.debugLineNum = 217;BA.debugLine="If(Result5 = DialogResponse.POSITIVE)Then";
if (true) break;
...
//C
this.state = 10;
 //BA.debugLineNum = 219;BA.debugLine="Btn_Etq1.Enabled = False";
...
this.state = 12;
;
 //BA.debugLineNum = 225;BA.debugLine="Etiquetas = ParseEtiquetas(vJson)";
parent.mostCurrent._etiquetas = _parseetiquetas(_vjson);
 //BA.debugLineNum = 227;BA.debugLine="For Each ET As Etiqueta In Etiquetas";
if (true) break;

case 12:
//for
this.state = 27;
group21 = parent.mostCurrent._etiquetas;
index21 = 0;
...
//C
this.state = 15;
 //BA.debugLineNum = 228;BA.debugLine="Dim job As HttpJob";
_job = new BaKapp.Movil.Tag.httpjob();
 //BA.debugLineNum = 229;BA.debugLine="job.Initialize(\"\", Me)";
_job._initialize /*String*/ (processBA,"",frm_etiquetas.getObject());
 //BA.debugLineNum = 232;BA.debugLine="Dim Ancho, Alto As Float";
_ancho = 0f;
_alto = 0f;
 //BA.debugLineNum = 234;BA.debugLine="Dim m As Matcher = Regex.Matcher(\"(\\d+)[xX](\\d+";
_m = new anywheresoftware.b4a.keywords.Regex.MatcherWrapper();
_m = anywheresoftware.b4a.keywords.Common.Regex.Matcher("(\\d+)[xX](\\d+)",_et.NombreEtiqueta /*String*/ );
 //BA.debugLineNum = 235;BA.debugLine="If m.Find Then";
if (true) break;
...
//C
this.state = 20;
 //BA.debugLineNum = 236;BA.debugLine="Ancho = m.Group(1)";
_ancho = (float)(Double.parseDouble(_m.Group((int) (1))));
 //BA.debugLineNum = 237;BA.debugLine="Alto = m.Group(2)";
_alto = (float)(Double.parseDouble(_m.Group((int) (2))));
 //BA.debugLineNum = 238;BA.debugLine="Ancho = Ancho / 2.54";
_ancho = (float) (_ancho/(double)2.54);
 //BA.debugLineNum = 239;BA.debugLine="Alto = Alto / 2.54";
_alto = (float) (_alto/(double)2.54);
 //BA.debugLineNum = 240;BA.debugLine="Ancho = NumberFormat2(Ancho, 1, 2, 2, False)";
...
//C
this.state = 20;
 //BA.debugLineNum = 246;BA.debugLine="job.PostString($\"https://api.labelary.com/v1/p";
...
this.state = 21;
;
 //BA.debugLineNum = 250;BA.debugLine="job.GetRequest.SetHeader(\"Accept\", \"image/png\")";
_job._getrequest /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ ().SetHeader("Accept","image/png");
 //BA.debugLineNum = 252;BA.debugLine="Wait For (job) JobDone(j As HttpJob)";
...
;
 //BA.debugLineNum = 253;BA.debugLine="If j.Success Then";
if (true) break;
...
//C
this.state = 26;
 //BA.debugLineNum = 254;BA.debugLine="Dim bmp As Bitmap = j.GetBitmap";
_bmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
_bmp = _j._getbitmap /*anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper*/ ();
 //BA.debugLineNum = 255;BA.debugLine="Dim Etiqueta As Map";
_etiqueta = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 256;BA.debugLine="Etiqueta.Initialize";
_etiqueta.Initialize();
 //BA.debugLineNum = 257;BA.debugLine="Etiqueta.Put(\"tipo\", ET.NombreEtiqueta)";
_etiqueta.Put((Object)("tipo"),(Object)(_et.NombreEtiqueta /*String*/ ));
 //BA.debugLineNum = 258;BA.debugLine="Etiqueta.Put(\"imagen\", bmp)";
_etiqueta.Put((Object)("imagen"),(Object)(_bmp.getObject()));
 //BA.debugLineNum = 261;BA.debugLine="ListaPersonas.Add(Etiqueta)";
...
this.state = 41;
;
 //BA.debugLineNum = 267;BA.debugLine="j.Release";
_j._release /*String*/ ();
 if (true) break;
if (true) break;
...
//C
this.state = 30;
 //BA.debugLineNum = 272;BA.debugLine="bmp1 = LoadBitmap(File.DirAssets, \"emoticon-sad.";
_bmp1 = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"emoticon-sad.png");
 //BA.debugLineNum = 273;BA.debugLine="Msgbox2Async(\"Error al traer las etiquetas.\", \"E";
anywheresoftware.b4a.keywords.Common.Msgbox2Async(BA.ObjectToCharSequence("Error al traer las etiquetas."),BA.ObjectToCharSequence("Error"),"OK","","",_bmp1,processBA,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 274;BA.debugLine="Wait For Msgbox_Result (Result5 As Int)";
anywheresoftware.b4a.keywords.Common.WaitFor("msgbox_result", processBA, this, null);
this.state = 43;
return;
case 43:
...
_result5 = (Integer) result[0];
;
 //BA.debugLineNum = 275;BA.debugLine="If(Result5 = DialogResponse.POSITIVE)Then";
if (true) break;
...
//C
this.state = 33;
 //BA.debugLineNum = 276;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 278;BA.debugLine="Btn_Etq1.Enabled = False";
parent.mostCurrent._btn_etq1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 if (true) break;
...
if (true) return ;
 if (true) break;
;
 //BA.debugLineNum = 284;BA.debugLine="For Each Etiqueta As Map In ListaPersonas";
...
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_p.GetView((int) (0)).getObject()));
 //BA.debugLineNum = 291;BA.debugLine="Dim img As ImageView = p.GetView(1) ' segundo co";
...
_img = (anywheresoftware.b4a.objects.ImageViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ImageViewWrapper(), (android.widget.ImageView)(_p.GetView((int) (1)).getObject()));
 //BA.debugLineNum = 293;BA.debugLine="lbl.Text = Etiqueta.Get(\"tipo\")";
_lbl.setText(BA.ObjectToCharSequence(_etiqueta.Get((Object)("tipo"))));
 //BA.debugLineNum = 294;BA.debugLine="img.Bitmap = Etiqueta.Get(\"imagen\")";
_img.setBitmap((android.graphics.Bitmap)(_etiqueta.Get((Object)("imagen"))));
 //BA.debugLineNum = 296;BA.debugLine="clv.Add(p, \"\")";
parent.mostCurrent._clv._add((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_p.getObject())),(Object)(""));
 if (true) break;
if (true) break;
...
String _stringnoprecio = "";
 //BA.debugLineNum = 172;BA.debugLine="Sub CrearDatos()";
 //BA.debugLineNum = 174;BA.debugLine="Dim datos As Map";
mostCurrent._datos = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 175;BA.debugLine="datos.Initialize";
mostCurrent._datos.Initialize();
 //BA.debugLineNum = 176;BA.debugLine="datos.Put(\"Ip\",Lbl_IP.Text )";
mostCurrent._datos.Put((Object)("Ip"),(Object)(mostCurrent._lbl_ip.getText()));
 //BA.debugLineNum = 177;BA.debugLine="datos.Put(\"Nombre\", Lbl_Nombre.Text )";
mostCurrent._datos.Put((Object)("Nombre"),(Object)(mostCurrent._lbl_nombre.getText()));
 //BA.debugLineNum = 178;BA.debugLine="datos.Put(\"Seleccionado\", SelectedPrice)";
mostCurrent._datos.Put((Object)("Seleccionado"),(Object)(_selectedprice));
 //BA.debugLineNum = 179;BA.debugLine="Dim ipText As String = Lbl_puerto.Text";
_iptext = mostCurrent._lbl_puerto.getText();
 //BA.debugLineNum = 180;BA.debugLine="Dim IpINT As Int =  ipText";
_ipint = (int)(Double.parseDouble(_iptext));
 //BA.debugLineNum = 181;BA.debugLine="datos.Put(\"Puerto\", IpINT)";
mostCurrent._datos.Put((Object)("Puerto"),(Object)(_ipint));
 //BA.debugLineNum = 182;BA.debugLine="Dim aux As OtherPriceData = DataPrice.Get(Selecte";
_aux = (BaKapp.Movil.Tag.frm_impresion._otherpricedata)(mostCurrent._dataprice.Get(_selectedprice));
 //BA.debugLineNum = 183;BA.debugLine="stringPrecio = aux.KOLT";
_stringprecio = _aux.KOLT /*String*/ ;
 //BA.debugLineNum = 184;BA.debugLine="Dim stringNoPrecio As String  = aux.NOKOLT";
_stringnoprecio = _aux.NOKOLT /*String*/ ;
 //BA.debugLineNum = 185;BA.debugLine="datos.Put(\"KOLT\",stringPrecio )";
mostCurrent._datos.Put((Object)("KOLT"),(Object)(_stringprecio));
 //BA.debugLineNum = 186;BA.debugLine="datos.Put(\"NOKOLT\",stringNoPrecio )";
mostCurrent._datos.Put((Object)("NOKOLT"),(Object)(_stringnoprecio));
 //BA.debugLineNum = 188;BA.debugLine="File.WriteMap(File.DirInternal, \"impresora.map\",";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 17;BA.debugLine="Dim Etiquetas As List";
mostCurrent._etiquetas = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 21;BA.debugLine="Private PrinterMap As Map";
mostCurrent._printermap = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 22;BA.debugLine="Private PrinterList As ListView";
mostCurrent._printerlist = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Private SelectedPrinterIP As String  ' IP de la i";
mostCurrent._selectedprinterip = "";
 //BA.debugLineNum = 24;BA.debugLine="Dim datos As Map";
mostCurrent._datos = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 25;BA.debugLine="Dim xui As XUI";
mostCurrent._xui = new anywheresoftware.b4a.objects.B4XViewWrapper.XUI();
 //BA.debugLineNum = 26;BA.debugLine="Dim IsEnabled As Boolean";
_isenabled = false;
 //BA.debugLineNum = 27;BA.debugLine="Private Btn_Conf As Button";
mostCurrent._btn_conf = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 28;BA.debugLine="Private Btn_Cerrar As Button";
mostCurrent._btn_cerrar = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 29;BA.debugLine="Private General As Panel";
mostCurrent._general = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 30;BA.debugLine="Private Panel_Conf As Panel";
mostCurrent._panel_conf = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Private Btn_Etq1 As Button";
mostCurrent._btn_etq1 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 32;BA.debugLine="Private Btn_Etq2 As Button";
mostCurrent._btn_etq2 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 33;BA.debugLine="Private Img_Venta As ImageView";
mostCurrent._img_venta = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 34;BA.debugLine="Private Img_bodega As ImageView";
mostCurrent._img_bodega = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 35;BA.debugLine="Private Btn_Ed_Nombre As Button";
mostCurrent._btn_ed_nombre = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 36;BA.debugLine="Private Btn_Ed_ID As Button";
mostCurrent._btn_ed_id = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 37;BA.debugLine="Private Lbl_Nombre As Label";
mostCurrent._lbl_nombre = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 38;BA.debugLine="Dim stringListPrice As List";
mostCurrent._stringlistprice = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 39;BA.debugLine="Private Lbl_Estado As Label";
mostCurrent._lbl_estado = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 40;BA.debugLine="Private Btn_Probar_Conexion As Button";
mostCurrent._btn_probar_conexion = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 41;BA.debugLine="Private Lbl_Imprimir As Label";
mostCurrent._lbl_imprimir = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 42;BA.debugLine="Private Lbl_IP As Label";
mostCurrent._lbl_ip = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 43;BA.debugLine="Private clv As CustomListView";
mostCurrent._clv = new b4a.example3.customlistview();
 //BA.debugLineNum = 44;BA.debugLine="Private ColorEnabled As Int = Colors.RGB(86,73,25";
_colorenabled = anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (86),(int) (73),(int) (255));
 //BA.debugLineNum = 45;BA.debugLine="Private ColorDisabled As Int = Colors.RGB(162,156";
_colordisabled = anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (162),(int) (156),(int) (255));
 //BA.debugLineNum = 46;BA.debugLine="Dim SelectedPrice As Int";
_selectedprice = 0;
 //BA.debugLineNum = 47;BA.debugLine="Private Btn_Guardar As Button";
...
mostCurrent._label5 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 49;BA.debugLine="Dim DataPrice As List";
mostCurrent._dataprice = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 50;BA.debugLine="Private Btn_Ed_Precio As Button";
mostCurrent._btn_ed_precio = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 51;BA.debugLine="Dim Changes As Boolean";
_changes = false;
...
mostCurrent._btn_volver = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 54;BA.debugLine="Private Lbl_precio_act As Label";
mostCurrent._lbl_precio_act = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 55;BA.debugLine="Private Lbl_puerto As Label";
mostCurrent._lbl_puerto = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 56;BA.debugLine="Private Btn_editarPuerto As Button";
...
BaKapp.Movil.Tag.frm_impresion._otherpricedata _aux = null;
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _bmp1 = null;
 //BA.debugLineNum = 345;BA.debugLine="Sub LeerDatos()";
 //BA.debugLineNum = 346;BA.debugLine="If File.Exists(File.DirInternal, \"impresora.map\")";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"impresora.map")) { 
 //BA.debugLineNum = 347;BA.debugLine="datos = File.ReadMap(File.DirInternal, \"impresor";
mostCurrent._datos = anywheresoftware.b4a.keywords.Common.File.ReadMap(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"impresora.map");
 //BA.debugLineNum = 348;BA.debugLine="Lbl_IP.Text = datos.Get(\"Ip\")";
mostCurrent._lbl_ip.setText(BA.ObjectToCharSequence(mostCurrent._datos.Get((Object)("Ip"))));
 //BA.debugLineNum = 349;BA.debugLine="Lbl_Nombre.Text = datos.Get(\"Nombre\")";
mostCurrent._lbl_nombre.setText(BA.ObjectToCharSequence(mostCurrent._datos.Get((Object)("Nombre"))));
 //BA.debugLineNum = 350;BA.debugLine="Lbl_precio_act.Text =  datos.Get(\"KOLT\")  &\"|\"&";
mostCurrent._lbl_precio_act.setText(BA.ObjectToCharSequence(BA.ObjectToString(mostCurrent._datos.Get((Object)("KOLT")))+"|"+BA.ObjectToString(mostCurrent._datos.Get((Object)("NOKOLT")))));
 //BA.debugLineNum = 351;BA.debugLine="Dim aux As OtherPriceData = DataPrice.Get(Select";
_aux = (BaKapp.Movil.Tag.frm_impresion._otherpricedata)(mostCurrent._dataprice.Get(_selectedprice));
 //BA.debugLineNum = 352;BA.debugLine="SelectedPrice = datos.Get(\"Seleccionado\")";
_selectedprice = (int)(BA.ObjectToNumber(mostCurrent._datos.Get((Object)("Seleccionado"))));
 //BA.debugLineNum = 353;BA.debugLine="stringPrecio = aux.KOLT";
_stringprecio = _aux.KOLT /*String*/ ;
 //BA.debugLineNum = 354;BA.debugLine="Lbl_puerto.Text = datos.Get(\"Puerto\")";
mostCurrent._lbl_puerto.setText(BA.ObjectToCharSequence(mostCurrent._datos.Get((Object)("Puerto"))));
 //BA.debugLineNum = 355;BA.debugLine="Dim bmp1 As Bitmap";
_bmp1 = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 356;BA.debugLine="bmp1 = LoadBitmap(File.DirAssets, \"printer.png\")";
_bmp1 = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"printer.png");
 //BA.debugLineNum = 357;BA.debugLine="Msgbox2Async(\"Se encontro la configuración de im";
anywheresoftware.b4a.keywords.Common.Msgbox2Async(BA.ObjectToCharSequence("Se encontro la configuración de impresora"),BA.ObjectToCharSequence("Impresora encontrada"),"Ok","","",_bmp1,processBA,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 358;BA.debugLine="Btn_Etq1.Enabled=True";
mostCurrent._btn_etq1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 359;BA.debugLine="Lbl_Imprimir.Visible = False";
mostCurrent._lbl_imprimir.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 361;BA.debugLine="Dim bmp1 As Bitmap";
_bmp1 = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 362;BA.debugLine="bmp1 = LoadBitmap(File.DirAssets, \"printer.png\")";
_bmp1 = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"printer.png");
 //BA.debugLineNum = 363;BA.debugLine="Msgbox2Async(\"Falta la configuración la configur";
anywheresoftware.b4a.keywords.Common.Msgbox2Async(BA.ObjectToCharSequence("Falta la configuración la configuración de la impresora."),BA.ObjectToCharSequence("Alerta"),"Ok","","",_bmp1,processBA,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 364;BA.debugLine="Btn_Conf_Click";
_btn_conf_click();
...
BaKapp.Movil.Tag.frm_impresion._etiqueta _data = null;
 //BA.debugLineNum = 324;BA.debugLine="Sub ParseEtiquetas(Json As String ) As List";
...
_tablelist = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_root.Get((Object)("Table"))));
 //BA.debugLineNum = 330;BA.debugLine="Dim result As List";
_result = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 331;BA.debugLine="result.Initialize";
_result.Initialize();
 //BA.debugLineNum = 333;BA.debugLine="For Each entry As Map In tableList";
...
_entry = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(group7.Get(index7)));
 //BA.debugLineNum = 334;BA.debugLine="Dim data As Etiqueta";
_data = new BaKapp.Movil.Tag.frm_impresion._etiqueta();
 //BA.debugLineNum = 335;BA.debugLine="data.Initialize";
_data.Initialize();
 //BA.debugLineNum = 336;BA.debugLine="data.NombreEtiqueta = entry.Get(\"NombreEtiqueta\"";
_data.NombreEtiqueta /*String*/  = BA.ObjectToString(_entry.Get((Object)("NombreEtiqueta")));
 //BA.debugLineNum = 337;BA.debugLine="data.FUNCION = entry.Get(\"FUNCION\")";
_data.FUNCION /*String*/  = BA.ObjectToString(_entry.Get((Object)("FUNCION")));
 //BA.debugLineNum = 340;BA.debugLine="result.Add(data)";
_result.Add((Object)(_data));
 }
};
 //BA.debugLineNum = 343;BA.debugLine="Return result";
...
BaKapp.Movil.Tag.frm_impresion._otherpricedata _data = null;
 //BA.debugLineNum = 115;BA.debugLine="Sub ParseOtherPriceJSON(json As String) As List";
 //BA.debugLineNum = 116;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 117;BA.debugLine="parser.Initialize(json)";
_parser.Initialize(_json);
 //BA.debugLineNum = 118;BA.debugLine="Dim root As Map = parser.NextObject";
_root = new anywheresoftware.b4a.objects.collections.Map();
_root = _parser.NextObject();
 //BA.debugLineNum = 119;BA.debugLine="Dim tableList As List = root.Get(\"Table\")";
_tablelist = new anywheresoftware.b4a.objects.collections.List();
_tablelist = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_root.Get((Object)("Table"))));
 //BA.debugLineNum = 121;BA.debugLine="Dim result As List";
_result = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 122;BA.debugLine="result.Initialize";
_result.Initialize();
 //BA.debugLineNum = 124;BA.debugLine="For Each entry As Map In tableList";
_entry = new anywheresoftware.b4a.objects.collections.Map();
{
final anywheresoftware.b4a.BA.IterableList group7 = _tablelist;
final int groupLen7 = group7.getSize()
...
for (; index7 < groupLen7;index7++){
_entry = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(group7.Get(index7)));
 //BA.debugLineNum = 125;BA.debugLine="Dim data As OtherPriceData";
_data = new BaKapp.Movil.Tag.frm_impresion._otherpricedata();
 //BA.debugLineNum = 126;BA.debugLine="data.Initialize";
_data.Initialize();
 //BA.debugLineNum = 127;BA.debugLine="data.TILT = entry.Get(\"TILT\")";
_data.TILT /*String*/  = BA.ObjectToString(_entry.Get((Object)("TILT")));
 //BA.debugLineNum = 128;BA.debugLine="data.KOLT = entry.Get(\"KOLT\")";
_data.KOLT /*String*/  = BA.ObjectToString(_entry.Get((Object)("KOLT")));
 //BA.debugLineNum = 129;BA.debugLine="data.MELT = entry.Get(\"MELT\")";
_data.MELT /*String*/  = BA.ObjectToString(_entry.Get((Object)("MELT")));
 //BA.debugLineNum = 130;BA.debugLine="data.MOLT = entry.Get(\"MOLT\")";
_data.MOLT /*String*/  = BA.ObjectToString(_entry.Get((Object)("MOLT")));
 //BA.debugLineNum = 131;BA.debugLine="data.TIMOLT = entry.Get(\"TIMOLT\")";
_data.TIMOLT /*String*/  = BA.ObjectToString(_entry.Get((Object)("TIMOLT")));
 //BA.debugLineNum = 132;BA.debugLine="data.NOKOLT = entry.Get(\"NOKOLT\")";
_data.NOKOLT /*String*/  = BA.ObjectToString(_entry.Get((Object)("NOKOLT")));
 //BA.debugLineNum = 134;BA.debugLine="If entry.ContainsKey(\"FEVI\") And entry.Get(\"FEVI";
if (_entry.ContainsKey((Object)("FEVI")) && _entry.Get((Object)("FEVI"))!= null) { 
 //BA.debugLineNum = 135;BA.debugLine="data.FEVI = entry.Get(\"FEVI\")";
_data.FEVI /*String*/  = BA.ObjectToString(_entry.Get((Object)("FEVI")));
 }else {
 //BA.debugLineNum = 137;BA.debugLine="data.FEVI = \"\"";
_data.FEVI /*String*/  = "";
 };
 //BA.debugLineNum = 140;BA.debugLine="data.OPERA = entry.Get(\"OPERA\")";
_data.OPERA /*String*/  = BA.ObjectToString(_entry.Get((Object)("OPERA")));
 //BA.debugLineNum = 141;BA.debugLine="data.ECUDEF01UD = entry.Get(\"ECUDEF01UD\")";
_data.ECUDEF01UD /*String*/  = BA.ObjectToString(_entry.Get((Object)("ECUDEF01UD")));
 //BA.debugLineNum = 142;BA.debugLine="data.ECUDEF02UD = entry.Get(\"ECUDEF02UD\")";
_data.ECUDEF02UD /*String*/  = BA.ObjectToString(_entry.Get((Object)("ECUDEF02UD")));
 //BA.debugLineNum = 144;BA.debugLine="result.Add(data)";
_result.Add((Object)(_data));
 }
};
 //BA.debugLineNum = 147;BA.debugLine="Return result";
if (true) return _result;
...
int _r = 0;
 //BA.debugLineNum = 419;BA.debugLine="Sub Ping(IP As String) As Boolean";
 //BA.debugLineNum = 420;BA.debugLine="Try";
try { //BA.debugLineNum = 421;BA.debugLine="Dim p As Phone";
_p = new anywheresoftware.b4a.phone.Phone();
 //BA.debugLineNum = 422;BA.debugLine="Dim r As Int = p.Shell(\"ping -c 1 -w 1 \" & IP, N";
_r = _p.Shell("ping -c 1 -w 1 "+_ip,(String[])(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 423;BA.debugLine="Return (r = 0)  ' Si el ping es exitoso, devuelv";
if (true) return (_r==0);
 } 
       catch (Exception e6) {
			processBA.setLastException(e6); //BA.debugLineNum = 425;BA.debugLine="Return False";
...
String _poststring = "";
BaKapp.Movil.Tag.httpjob _js = null;
 //BA.debugLineNum = 150;BA.debugLine="Public Sub Sb_BuscarListaPrecios(Me_ As Object) As";
 //BA.debugLineNum = 152;BA.debugLine="Dim vXml As String = $\"<?xml version=\"1.0\" encodi";
_vxml = ("<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"+"<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">\n"+"  <soap:Body>\n"+"    <Sb_BuscarListaPrecios xmlns=\"http://BakApp\" />\n"+"  </soap:Body>\n"+"</soap:Envelope>");
 //BA.debugLineNum = 158;BA.debugLine="Dim PostString As String =\"http://\" & Variables.G";
_poststring = "http://"+mostCurrent._variables._global_ip_webservice /*String*/ +"/Ws_BakApp.asmx";
 //BA.debugLineNum = 159;BA.debugLine="Dim Js As HttpJob";
_js = new BaKapp.Movil.Tag.httpjob();
 //BA.debugLineNum = 161;BA.debugLine="Js.Initialize(\"\",Me_)'";
_js._initialize /*String*/ (processBA,"",_me_);
 //BA.debugLineNum = 162;BA.debugLine="Js.PostString(PostString,vXml)";
_js._poststring /*String*/ (_poststring,_vxml);
 //BA.debugLineNum = 163;BA.debugLine="Js.GetRequest.SetContentType(\"text/xml; charset=u";
_js._getrequest /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ ().SetContentType("text/xml; charset=utf-8");
 //BA.debugLineNum = 164;BA.debugLine="Js.GetRequest.SetHeader(\"SOAPAction\",$\"\"http://Ba";
_js._getrequest /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ ().SetHeader("SOAPAction",("\"http://BakApp/Sb_BuscarListaPrecios\""));
 //BA.debugLineNum = 166;BA.debugLine="Return Js";
if (true) return _js;
...
String _poststring = "";
BaKapp.Movil.Tag.httpjob _js = null;
 //BA.debugLineNum = 303;BA.debugLine="Private Sub Sb_TraerEtiquetas(Me_ As Object) As Ht";
 //BA.debugLineNum = 305;BA.debugLine="Dim vXml As String = $\"<?xml version=\"1.0\" encodi";
_vxml = ("<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"+"<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">\n"+"  <soap:Body>\n"+"    <Sb_TraerEtiquetas xmlns=\"http://BakApp\" />\n"+"  </soap:Body>\n"+"</soap:Envelope>\n"+"");
 //BA.debugLineNum = 313;BA.debugLine="Dim PostString As String =\"http://\" & Variables.G";
_poststring = "http://"+mostCurrent._variables._global_ip_webservice /*String*/ +"/Ws_BakApp.asmx";
 //BA.debugLineNum = 314;BA.debugLine="Dim Js As HttpJob";
_js = new BaKapp.Movil.Tag.httpjob();
 //BA.debugLineNum = 316;BA.debugLine="Js.Initialize(\"\",Me_)'";
_js._initialize /*String*/ (processBA,"",_me_);
 //BA.debugLineNum = 317;BA.debugLine="Js.PostString(PostString,vXml)";
_js._poststring /*String*/ (_poststring,_vxml);
 //BA.debugLineNum = 318;BA.debugLine="Js.GetRequest.SetContentType(\"text/xml; charset=u";
_js._getrequest /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ ().SetContentType("text/xml; charset=utf-8");
 //BA.debugLineNum = 319;BA.debugLine="Js.GetRequest.SetHeader(\"SOAPAction\",$\"\"http://Ba";
_js._getrequest /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ ().SetHeader("SOAPAction",("\"http://BakApp/Sb_TraerEtiquetas\""));
 //BA.debugLineNum = 320;BA.debugLine="Return Js";
if (true) return _js;
