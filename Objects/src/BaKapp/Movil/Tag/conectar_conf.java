...
parent.__c.LogImpl("65832720","2.- Una vez que ya tenemos el nombre cargamos la configuración de la estación en la tabla Zw_EstacionesBkp",0);
...
parent.__c.LogImpl("65832722","Configuracion_Estacion_Cargada",0);
...
parent.__c.LogImpl("66029331","6.- Cargamos la configuración por Estación CONFIEST",0);
...
parent.__c.LogImpl("66029369","7.- Cargamos la configuración General",0);
 //BA.debugLineNum = 196;BA.debugLine="Log(\"Fecha servidor: \" & Variables.Gl_Fecha_S";
parent.__c.LogImpl("66029370","Fecha servidor: "+parent._variables._gl_fecha_servidor /*String*/ ,0);
...
parent.__c.LogImpl("66029380","Error al cargar Configuracion General",0);
 //BA.debugLineNum = 207;BA.debugLine="Log(Js.ErrorMessage)";
parent.__c.LogImpl("66029381",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("66029389",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("65963795","5.- Traemos la lista de precios asociadas al usuario, con las que puede trabajar",0);
...
parent.__c.LogImpl("66291472","Traemos la lista de tipos de documentos para despacho simple",0);
...
parent.__c.LogImpl("66357008","Traemos la lista de tipos de despacho o retiro",0);
...
parent.__c.LogImpl("66422544","Traemos la lista de tipos de pago",0);
...
parent.__c.LogImpl("65767185","1.- Obtenemos primero el nombre de la base de datos de Bakapp",0);
...
parent.__c.LogImpl("65767188","DB BakApp: "+parent._variables._global_basebk /*String*/ ,0);
...
parent.__c.LogImpl("65898258","4.- Cargamos al usuario por defecto y lo traemos",0);
...
parent.__c.LogImpl("66094872","3.- Iniciamos la sesion",0);
...
parent.__c.LogImpl("66160430",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("66160446",_js._errormessage /*String*/ ,0);
 if (true) break;
