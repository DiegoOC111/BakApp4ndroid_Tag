...
parent.__c.LogImpl("78781840","2.- Una vez que ya tenemos el nombre cargamos la configuración de la estación en la tabla Zw_EstacionesBkp",0);
...
parent.__c.LogImpl("78781842","Configuracion_Estacion_Cargada",0);
...
parent.__c.LogImpl("78978451","6.- Cargamos la configuración por Estación CONFIEST",0);
...
parent.__c.LogImpl("78978489","7.- Cargamos la configuración General",0);
 //BA.debugLineNum = 196;BA.debugLine="Log(\"Fecha servidor: \" & Variables.Gl_Fecha_S";
parent.__c.LogImpl("78978490","Fecha servidor: "+parent._variables._gl_fecha_servidor /*String*/ ,0);
...
parent.__c.LogImpl("78978500","Error al cargar Configuracion General",0);
 //BA.debugLineNum = 207;BA.debugLine="Log(Js.ErrorMessage)";
parent.__c.LogImpl("78978501",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("78978509",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("78912915","5.- Traemos la lista de precios asociadas al usuario, con las que puede trabajar",0);
...
parent.__c.LogImpl("79240592","Traemos la lista de tipos de documentos para despacho simple",0);
...
parent.__c.LogImpl("79306128","Traemos la lista de tipos de despacho o retiro",0);
...
parent.__c.LogImpl("79371664","Traemos la lista de tipos de pago",0);
...
parent.__c.LogImpl("78716305","1.- Obtenemos primero el nombre de la base de datos de Bakapp",0);
...
parent.__c.LogImpl("78716308","DB BakApp: "+parent._variables._global_basebk /*String*/ ,0);
...
parent.__c.LogImpl("78847378","4.- Cargamos al usuario por defecto y lo traemos",0);
...
parent.__c.LogImpl("79043992","3.- Iniciamos la sesion",0);
...
parent.__c.LogImpl("79109550",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("79109566",_js._errormessage /*String*/ ,0);
 if (true) break;
