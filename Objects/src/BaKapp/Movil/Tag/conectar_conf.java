...
parent.__c.LogImpl("75046288","2.- Una vez que ya tenemos el nombre cargamos la configuración de la estación en la tabla Zw_EstacionesBkp",0);
...
parent.__c.LogImpl("75046290","Configuracion_Estacion_Cargada",0);
...
parent.__c.LogImpl("75242899","6.- Cargamos la configuración por Estación CONFIEST",0);
...
parent.__c.LogImpl("75242937","7.- Cargamos la configuración General",0);
 //BA.debugLineNum = 196;BA.debugLine="Log(\"Fecha servidor: \" & Variables.Gl_Fecha_S";
parent.__c.LogImpl("75242938","Fecha servidor: "+parent._variables._gl_fecha_servidor /*String*/ ,0);
...
parent.__c.LogImpl("75242948","Error al cargar Configuracion General",0);
 //BA.debugLineNum = 207;BA.debugLine="Log(Js.ErrorMessage)";
parent.__c.LogImpl("75242949",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("75242957",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("75177363","5.- Traemos la lista de precios asociadas al usuario, con las que puede trabajar",0);
...
parent.__c.LogImpl("75505040","Traemos la lista de tipos de documentos para despacho simple",0);
...
parent.__c.LogImpl("75570576","Traemos la lista de tipos de despacho o retiro",0);
...
parent.__c.LogImpl("75636112","Traemos la lista de tipos de pago",0);
...
parent.__c.LogImpl("74980753","1.- Obtenemos primero el nombre de la base de datos de Bakapp",0);
...
parent.__c.LogImpl("74980756","DB BakApp: "+parent._variables._global_basebk /*String*/ ,0);
...
parent.__c.LogImpl("75111826","4.- Cargamos al usuario por defecto y lo traemos",0);
...
parent.__c.LogImpl("75308440","3.- Iniciamos la sesion",0);
...
parent.__c.LogImpl("75373998",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("75374014",_js._errormessage /*String*/ ,0);
 if (true) break;
