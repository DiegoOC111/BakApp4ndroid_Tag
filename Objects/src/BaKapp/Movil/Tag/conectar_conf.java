...
parent.__c.LogImpl("416384016","2.- Una vez que ya tenemos el nombre cargamos la configuración de la estación en la tabla Zw_EstacionesBkp",0);
...
parent.__c.LogImpl("416384018","Configuracion_Estacion_Cargada",0);
...
parent.__c.LogImpl("416580627","6.- Cargamos la configuración por Estación CONFIEST",0);
...
parent.__c.LogImpl("416580665","7.- Cargamos la configuración General",0);
 //BA.debugLineNum = 196;BA.debugLine="Log(\"Fecha servidor: \" & Variables.Gl_Fecha_S";
parent.__c.LogImpl("416580666","Fecha servidor: "+parent._variables._gl_fecha_servidor /*String*/ ,0);
...
parent.__c.LogImpl("416580676","Error al cargar Configuracion General",0);
 //BA.debugLineNum = 207;BA.debugLine="Log(Js.ErrorMessage)";
parent.__c.LogImpl("416580677",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("416580685",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("416515091","5.- Traemos la lista de precios asociadas al usuario, con las que puede trabajar",0);
...
parent.__c.LogImpl("416842768","Traemos la lista de tipos de documentos para despacho simple",0);
...
parent.__c.LogImpl("416908304","Traemos la lista de tipos de despacho o retiro",0);
...
parent.__c.LogImpl("416973840","Traemos la lista de tipos de pago",0);
...
parent.__c.LogImpl("416318481","1.- Obtenemos primero el nombre de la base de datos de Bakapp",0);
...
parent.__c.LogImpl("416318484","DB BakApp: "+parent._variables._global_basebk /*String*/ ,0);
...
parent.__c.LogImpl("416449554","4.- Cargamos al usuario por defecto y lo traemos",0);
...
parent.__c.LogImpl("416646168","3.- Iniciamos la sesion",0);
...
parent.__c.LogImpl("416711726",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("416711742",_js._errormessage /*String*/ ,0);
 if (true) break;
