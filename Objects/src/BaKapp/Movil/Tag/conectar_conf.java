...
parent.__c.LogImpl("17143440","2.- Una vez que ya tenemos el nombre cargamos la configuración de la estación en la tabla Zw_EstacionesBkp",0);
...
parent.__c.LogImpl("17143442","Configuracion_Estacion_Cargada",0);
...
parent.__c.LogImpl("17340051","6.- Cargamos la configuración por Estación CONFIEST",0);
...
parent.__c.LogImpl("17340089","7.- Cargamos la configuración General",0);
 //BA.debugLineNum = 196;BA.debugLine="Log(\"Fecha servidor: \" & Variables.Gl_Fecha_S";
parent.__c.LogImpl("17340090","Fecha servidor: "+parent._variables._gl_fecha_servidor /*String*/ ,0);
...
parent.__c.LogImpl("17340100","Error al cargar Configuracion General",0);
 //BA.debugLineNum = 207;BA.debugLine="Log(Js.ErrorMessage)";
parent.__c.LogImpl("17340101",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("17340109",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("17274515","5.- Traemos la lista de precios asociadas al usuario, con las que puede trabajar",0);
...
parent.__c.LogImpl("17602192","Traemos la lista de tipos de documentos para despacho simple",0);
...
parent.__c.LogImpl("17667728","Traemos la lista de tipos de despacho o retiro",0);
...
parent.__c.LogImpl("17733264","Traemos la lista de tipos de pago",0);
...
parent.__c.LogImpl("17077905","1.- Obtenemos primero el nombre de la base de datos de Bakapp",0);
...
parent.__c.LogImpl("17077908","DB BakApp: "+parent._variables._global_basebk /*String*/ ,0);
...
parent.__c.LogImpl("17208978","4.- Cargamos al usuario por defecto y lo traemos",0);
...
parent.__c.LogImpl("17405592","3.- Iniciamos la sesion",0);
...
parent.__c.LogImpl("17471150",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("17471166",_js._errormessage /*String*/ ,0);
 if (true) break;
