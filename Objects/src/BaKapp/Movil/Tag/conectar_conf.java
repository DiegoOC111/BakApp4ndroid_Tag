...
parent.__c.LogImpl("714614544","2.- Una vez que ya tenemos el nombre cargamos la configuración de la estación en la tabla Zw_EstacionesBkp",0);
...
parent.__c.LogImpl("714614546","Configuracion_Estacion_Cargada",0);
...
parent.__c.LogImpl("714811155","6.- Cargamos la configuración por Estación CONFIEST",0);
...
parent.__c.LogImpl("714811193","7.- Cargamos la configuración General",0);
 //BA.debugLineNum = 196;BA.debugLine="Log(\"Fecha servidor: \" & Variables.Gl_Fecha_S";
parent.__c.LogImpl("714811194","Fecha servidor: "+parent._variables._gl_fecha_servidor /*String*/ ,0);
...
parent.__c.LogImpl("714811204","Error al cargar Configuracion General",0);
 //BA.debugLineNum = 207;BA.debugLine="Log(Js.ErrorMessage)";
parent.__c.LogImpl("714811205",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("714811213",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("714745619","5.- Traemos la lista de precios asociadas al usuario, con las que puede trabajar",0);
...
parent.__c.LogImpl("715073296","Traemos la lista de tipos de documentos para despacho simple",0);
...
parent.__c.LogImpl("715138832","Traemos la lista de tipos de despacho o retiro",0);
...
parent.__c.LogImpl("715204368","Traemos la lista de tipos de pago",0);
...
parent.__c.LogImpl("714549009","1.- Obtenemos primero el nombre de la base de datos de Bakapp",0);
...
parent.__c.LogImpl("714549012","DB BakApp: "+parent._variables._global_basebk /*String*/ ,0);
...
parent.__c.LogImpl("714680082","4.- Cargamos al usuario por defecto y lo traemos",0);
...
parent.__c.LogImpl("714876696","3.- Iniciamos la sesion",0);
...
parent._consulta_sql = ("Select TOP 1 * From MAEMO Where KOMO = 'US$' AND CAST(FEMO AS DATE) = CAST(GETDATE() AS DATE)Order by IDMAEMO DESC");
...
parent.__c.LogImpl("714942254",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("714942270",_js._errormessage /*String*/ ,0);
 if (true) break;
