...
parent.__c.LogImpl("23932176","2.- Una vez que ya tenemos el nombre cargamos la configuración de la estación en la tabla Zw_EstacionesBkp",0);
...
parent.__c.LogImpl("23932178","Configuracion_Estacion_Cargada",0);
...
parent.__c.LogImpl("24128787","6.- Cargamos la configuración por Estación CONFIEST",0);
...
parent.__c.LogImpl("24128825","7.- Cargamos la configuración General",0);
 //BA.debugLineNum = 196;BA.debugLine="Log(\"Fecha servidor: \" & Variables.Gl_Fecha_S";
parent.__c.LogImpl("24128826","Fecha servidor: "+parent._variables._gl_fecha_servidor /*String*/ ,0);
...
parent.__c.LogImpl("24128836","Error al cargar Configuracion General",0);
 //BA.debugLineNum = 207;BA.debugLine="Log(Js.ErrorMessage)";
parent.__c.LogImpl("24128837",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("24128845",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("24063251","5.- Traemos la lista de precios asociadas al usuario, con las que puede trabajar",0);
...
parent.__c.LogImpl("24390928","Traemos la lista de tipos de documentos para despacho simple",0);
...
parent.__c.LogImpl("24456464","Traemos la lista de tipos de despacho o retiro",0);
...
parent.__c.LogImpl("24522000","Traemos la lista de tipos de pago",0);
...
parent.__c.LogImpl("23866641","1.- Obtenemos primero el nombre de la base de datos de Bakapp",0);
...
parent.__c.LogImpl("23866644","DB BakApp: "+parent._variables._global_basebk /*String*/ ,0);
...
parent.__c.LogImpl("23997714","4.- Cargamos al usuario por defecto y lo traemos",0);
...
parent.__c.LogImpl("24194328","3.- Iniciamos la sesion",0);
...
parent.__c.LogImpl("24259886",_js._errormessage /*String*/ ,0);
 if (true) break;
...
parent.__c.LogImpl("24259902",_js._errormessage /*String*/ ,0);
 if (true) break;
