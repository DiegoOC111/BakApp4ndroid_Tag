...
anywheresoftware.b4a.keywords.Common.LogImpl("1131136","No existe el archivo ConexionWebService.txt",0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("1131144",parent.mostCurrent._variables._global_ip_webservice /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("1458760",_vclave,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("1458819",_js._errormessage /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("1458834",parent.mostCurrent._variables._global_basebk /*String*/ ,0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("1458839",_js._errormessage /*String*/ ,0);
 if (true) break;
