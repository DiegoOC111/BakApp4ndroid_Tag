...
public class xml2map extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "BaKapp.Movil.Tag.xml2map");
            if (htSubs == null) {
...
public BaKapp.Movil.Tag.xml2map._xmlelement  _createelement(String _name) throws Exception{
...
public Object  _elementtoobject(BaKapp.Movil.Tag.xml2map._xmlelement _element) throws Exception{
...
public BaKapp.Movil.Tag.xml2map._xmlelement  _getlastelement() throws Exception{
...
if (true) return (BaKapp.Movil.Tag.xml2map._xmlelement)(_elements.Get((int) (_elements.getSize()-1)));
...
_m = new anywheresoftware.b4a.objects.collections.Map();
_m = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_elementtoobject((BaKapp.Movil.Tag.xml2map._xmlelement)(_elements.Get((int) (0))))));
