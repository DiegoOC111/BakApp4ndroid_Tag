...
anywheresoftware.b4a.keywords.Common.LogImpl("619202099",_vjson,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("619202155",parent.mostCurrent._lbl_idmaeedo.getText(),0);
 if (true) break;
if (true) break;
