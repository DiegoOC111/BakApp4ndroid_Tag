...
anywheresoftware.b4a.keywords.Common.LogImpl("111993139",_vjson,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("111993195",parent.mostCurrent._lbl_idmaeedo.getText(),0);
 if (true) break;
if (true) break;
