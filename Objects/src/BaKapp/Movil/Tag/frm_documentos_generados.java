...
anywheresoftware.b4a.keywords.Common.LogImpl("213631539",_vjson,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("213631595",parent.mostCurrent._lbl_idmaeedo.getText(),0);
 if (true) break;
if (true) break;
