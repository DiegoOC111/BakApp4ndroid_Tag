...
anywheresoftware.b4a.keywords.Common.LogImpl("419333171",_vjson,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("419333227",parent.mostCurrent._lbl_idmaeedo.getText(),0);
 if (true) break;
if (true) break;
