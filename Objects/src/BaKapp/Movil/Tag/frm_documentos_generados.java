...
anywheresoftware.b4a.keywords.Common.LogImpl("719071027",_vjson,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("719071083",parent.mostCurrent._lbl_idmaeedo.getText(),0);
 if (true) break;
if (true) break;
