...
anywheresoftware.b4a.keywords.Common.LogImpl("718546739",_vjson,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("718546795",parent.mostCurrent._lbl_idmaeedo.getText(),0);
 if (true) break;
if (true) break;
