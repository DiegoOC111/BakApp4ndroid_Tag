...
try {
		Debug.PushSubsStack("CreateElement (xml2map) ","xml2map",28,__ref.getField(false, "ba"),__ref,55);
if (RapidSub.canDelegate("createelement")) { return __ref.runUserSub(false, "xml2map","createelement", __ref, _name);}
RemoteObject _xe = RemoteObject.declareNull("BaKapp.Movil.Tag.xml2map._xmlelement");
...
_xe = RemoteObject.createNew ("BaKapp.Movil.Tag.xml2map._xmlelement");Debug.locals.put("xe", _xe);
...
try {
		Debug.PushSubsStack("ElementToObject (xml2map) ","xml2map",28,__ref.getField(false, "ba"),__ref,29);
...
RemoteObject _child = RemoteObject.declareNull("BaKapp.Movil.Tag.xml2map._xmlelement");
...
Debug.ShouldStop(8);
_childobject = __ref.runClassMethod (BaKapp.Movil.Tag.xml2map.class, "_elementtoobject" /*RemoteObject*/ ,(Object)(_child));Debug.locals.put("childObject", _childobject);Debug.locals.put("childObject", _childobject);
...
try {
		Debug.PushSubsStack("GetLastElement (xml2map) ","xml2map",28,__ref.getField(false, "ba"),__ref,86);
...
try {
		Debug.PushSubsStack("Initialize (xml2map) ","xml2map",28,__ref.getField(false, "ba"),__ref,10);
...
try {
		Debug.PushSubsStack("Parse (xml2map) ","xml2map",28,__ref.getField(false, "ba"),__ref,14);
...
if (true) return __ref.runClassMethod (BaKapp.Movil.Tag.xml2map.class, "_parse2" /*RemoteObject*/ ,(Object)(_in));
...
try {
		Debug.PushSubsStack("Parse2 (xml2map) ","xml2map",28,__ref.getField(false, "ba"),__ref,21);
...
Debug.ShouldStop(4194304);
__ref.getField(false,"_elements" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((__ref.runClassMethod (BaKapp.Movil.Tag.xml2map.class, "_createelement" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("stub"))))));
...
_m = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), __ref.runClassMethod (BaKapp.Movil.Tag.xml2map.class, "_elementtoobject" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_elements" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)))))));Debug.locals.put("m", _m);Debug.locals.put("m", _m);
...
try {
		Debug.PushSubsStack("Parser_EndElement (xml2map) ","xml2map",28,__ref.getField(false, "ba"),__ref,90);
if (RapidSub.canDelegate("parser_endelement")) { return __ref.runUserSub(false, "xml2map","parser_endelement", __ref, _uri, _name, _text);}
RemoteObject _element = RemoteObject.declareNull("BaKapp.Movil.Tag.xml2map._xmlelement");
...
Debug.ShouldStop(67108864);
_element = __ref.runClassMethod (BaKapp.Movil.Tag.xml2map.class, "_getlastelement" /*RemoteObject*/ );Debug.locals.put("Element", _element);Debug.locals.put("Element", _element);
...
try {
		Debug.PushSubsStack("Parser_StartElement (xml2map) ","xml2map",28,__ref.getField(false, "ba"),__ref,67);
...
Debug.ShouldStop(16);
_element = __ref.runClassMethod (BaKapp.Movil.Tag.xml2map.class, "_createelement" /*RemoteObject*/ ,(Object)(_name));Debug.locals.put("Element", _element);Debug.locals.put("Element", _element);
...
Debug.ShouldStop(131072);
__ref.runClassMethod (BaKapp.Movil.Tag.xml2map.class, "_getlastelement" /*RemoteObject*/ ).getField(false,"Children" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((_element)));
