...
public class tidonudo {
    public static RemoteObject myClass;
	public tidonudo() {
	}
    public static PCBA staticBA = new PCBA(null, tidonudo.class);

public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _tido = RemoteObject.createImmutable("");
public static RemoteObject _notido = RemoteObject.createImmutable("");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"Notido",_ref.getField(false, "_notido"),"Tido",_ref.getField(false, "_tido")};
}
}