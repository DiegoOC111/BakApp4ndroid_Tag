...
public class frm_menu_post_venta implements IRemote{
	public static frm_menu_post_venta mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public frm_menu_post_venta() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("frm_menu_post_venta"), "BaKapp.Movil.Tag.frm_menu_post_venta");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, frm_menu_post_venta.class);
...
public static RemoteObject _btn_venta = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _btn_buscar_documentos = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _btn_ver_documentos = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
