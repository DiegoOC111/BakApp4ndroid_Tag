...
public static RemoteObject _lbl_nom = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _imgview = RemoteObject.declareNull("BaKapp.Movil.Tag.b4ximageview");
