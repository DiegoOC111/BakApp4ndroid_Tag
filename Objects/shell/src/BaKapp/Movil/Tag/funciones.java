...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("BaKapp.Movil.Tag.funciones");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("funciones"), "BaKapp.Movil.Tag.funciones");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("BaKapp.Movil.Tag.funciones"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
