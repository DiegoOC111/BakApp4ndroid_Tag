...
public class cl_conf_local {
    public static RemoteObject myClass;
	public cl_conf_local() {
	}
    public static PCBA staticBA = new PCBA(null, cl_conf_local.class);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"Consulta_Sql",_ref.getField(false, "_consulta_sql"),"DateUtils",_ref.getField(false, "_dateutils")};
}
}