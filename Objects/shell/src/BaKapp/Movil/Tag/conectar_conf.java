...
public class conectar_conf {
    public static RemoteObject myClass;
	public conectar_conf() {
	}
    public static PCBA staticBA = new PCBA(null, conectar_conf.class);

public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _consulta_sql = RemoteObject.createImmutable("");
public static RemoteObject _verror = RemoteObject.createImmutable("");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"bmp1",_ref.getField(false, "_bmp1"),"Consulta_Sql",_ref.getField(false, "_consulta_sql"),"DateUtils",_ref.getField(false, "_dateutils"),"Estado",_ref.getField(false, "_estado"),"vError",_ref.getField(false, "_verror")};
}
}