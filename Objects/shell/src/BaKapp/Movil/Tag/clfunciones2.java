...
public class clfunciones2 {
    public static RemoteObject myClass;
	public clfunciones2() {
	}
    public static PCBA staticBA = new PCBA(null, clfunciones2.class);
...
public static RemoteObject _newpara = RemoteObject.createImmutable("");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"Consulta_Sql",_ref.getField(false, "_consulta_sql"),"DateUtils",_ref.getField(false, "_dateutils"),"mBase",_ref.getField(false, "_mbase"),"mCallBack",_ref.getField(false, "_mcallback"),"mEventName",_ref.getField(false, "_meventname"),"NewPara",_ref.getField(false, "_newpara"),"Tag",_ref.getField(false, "_tag"),"xui",_ref.getField(false, "_xui")};
}
}